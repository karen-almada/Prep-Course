...
function arrayContiene(array, elemento) {
  ...
  //SINO TAMBIEN PUEDE SER RETURN ARRAY.INCLUDES(ELEMENTOS);
...
if (unMesdado==="enero"||unMesdado==="marzo"||unMesdado==="Noviembre"){
  ...
  if (miArray.length !==3) return "No se encontrarpn los meses pedidos";
  return miArray;
